...
-- Thời gian đã tạo: Th7 21, 2026 lúc 12:12 PM
...
(9, 'admin@teestudio.vn', '$2b$10$hash9', 'Quản Trị Viên', '0909090909', 'ADMIN', 'INACTIVE', 1, '2026-01-02 08:08:00', '2026-01-02 08:08:00', '2026-07-20 18:12:29'),
(10, 'test.tonkho.customer@teestudio.vn', '$2b$10$seedInventoryCustomerHash', 'Khách Test Tồn Kho', '0900000999', 'CUSTOMER', 'ACTIVE', 1, '2026-01-02 08:09:00', '2026-01-02 08:09:00', '2026-07-20 18:12:29'),
(11, 'thanhhieu2182004@gmail.com', '$2b$12$dej0jQlYcNB4himKZXnTyO1mAifhTx04Y3kUyy8ot/h5/geo/zOIO', 'Nguyen Thanh Hieu', '0123456789', 'ADMIN', 'ACTIVE', 1, '2026-06-10 11:42:19', '2026-06-10 11:42:19', '2026-07-20 18:12:29'),
(12, 'thanhhieu282004@gmail.com', '$2b$12$IOC5ktoj07Rk/LELF9OsmOtzDltRyhbI2VEexhx.uzB/bHh.Ql6zu', 'Nguyen Thanh Hieu', '0123456789', 'WAREHOUSE', 'ACTIVE', 1, '2026-06-10 11:46:32', '2026-06-10 11:46:32', '2026-07-20 18:12:29'),
...
(15, 'dangcuh2105@gmail.com', '$2b$12$3vzWRYqdZF0WZg/kj2uSv.e7Ot3pwHgbNl06yC5yglXqhWccYB8AW', 'Nguyễn Đăng', '02312312323', 'ADMIN', 'ACTIVE', 1, '2026-06-21 15:54:52', '2026-06-21 15:54:52', '2026-07-20 18:12:29'),
(16, '1212@gmail.com', '$2b$12$M32aaDqfG3RXEMxe2VCdEupS7.oI7ZW6lpySPRLPBv5/4SEJ3Tr.W', 'abc', '0123456789', 'CUSTOMER', 'ACTIVE', 1, '2026-06-21 16:48:08', '2026-06-21 16:48:08', '2026-07-20 18:12:29'),
(18, 'admin2@teestudio.vn', '$2b$10$JXB.1D1fQPZJL3EG771ReuQYXggSl/wJS9DiVNbNcgge.8EYOWjuS', 'Admin Chính', '0987654321', 'ADMIN', 'ACTIVE', 1, '2026-06-23 17:02:26', '2026-06-23 17:02:26', '2026-07-20 18:12:29'),
...
(21, 'test.task1@teestudio.dev', '$2b$10$KH1ACekWdi5j6Bx.8In7M.9jOc0cHHflJ1W8wbxr3fNl0vDlSMJpO', 'Test Task1', '0912345678', 'CUSTOMER', 'ACTIVE', 1, '2026-07-17 17:04:05', '2026-07-17 17:04:05', '2026-07-20 18:12:29'),
(24, 'haidang40021181@gmail.com', '$2b$12$17RJfgLPpWmnJBVG8In5MOpMYWaTXE5OXJBy76cTy.tcEL.HNwl3y', 'Nguyễn Hải Đăng', '03242345878', 'CUSTOMER', 'ACTIVE', 1, '2026-07-18 20:36:46', '2026-07-18 20:36:46', '2026-07-20 18:12:29');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `accountactiontoken`
--
...
CREATE TABLE IF NOT EXISTS `accountactiontoken` (
  ...
  `tokenHash` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'SHA-256 hash of raw token',
  `purpose` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'EMAIL_VERIFICATION | PASSWORD_RESET',
  `expiresAt` datetime NOT NULL,
  `consumedAt` datetime DEFAULT NULL,
  `requestIp` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `bulkpricing`
--
...
CREATE TABLE IF NOT EXISTS `customdesign` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'Thiết kế chưa đặt tên' COMMENT '[FROM MEMBER] Tên thiết kế do khách đặt',
  ...
  `printFileUrlFront` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `printFileUrlBack` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(8, 16, 1, 2, 'Thiết kế c1', '#ffffff', '{\"elements\": [{\"x\": 200.2857142857136, \"y\": 235.48571428571415, \"id\": \"ddea394b-d98f-4d7b-9076-635d6fc570eb\", \"fill\": \"#000000\", \"text\": \"Văn bản mẫu\", \"type\": \"text\", \"width\": 121.71428571428636, \"height\": 27.999999999999982, \"fontSize\": 27.999999999999982, \"rotation\": 0, \"fontStyle\": \"normal\", \"fontFamily\": \"Great Vibes\"}], \"shirtView\": \"front\"}', 'https://res.cloudinary.com/dwol6aarv/image/upload/v1782221859/teestudio/user-designs/lodmjw2cfeack61etict.png', NULL, NULL, 0.00, 'DRAFT', NULL, '2026-06-23 20:37:41', '2026-07-18 19:17:30'),
...
(10, 16, 1, 2, 'Thiết kế chưa đặt tên', '#ffffff', '{\"elements\": [{\"x\": 167.8571428571429, \"y\": 165.57142857142856, \"id\": \"96f497c3-73dd-4f78-a670-e6297906b786\", \"src\": \"https://res.cloudinary.com/dwol6aarv/image/upload/v1782034047/planner_8512483_u5u7mb.png\", \"type\": \"image\", \"width\": 138, \"height\": 138, \"rotation\": 0}], \"shirtView\": \"front\"}', 'https://res.cloudinary.com/dwol6aarv/image/upload/v1784391662/teestudio/user-designs/l2giyu5svj2wx4zbv1ob.png', 'https://res.cloudinary.com/dwol6aarv/image/upload/v1784391718/teestudio/print-files/e631k69hansud6ygn6gp.png', NULL, 0.00, 'PENDING_REVIEW', NULL, '2026-07-04 16:30:36', '2026-07-18 23:22:01'),
(11, 2, 3, 14, 'Hoodie Câu lạc bộ Nhiếp ảnh', '#000000', '{\"elements\": [{\"x\": 90, \"y\": 110, \"fill\": \"#FFFFFF\", \"text\": \"CAPTURE THE MOMENT\", \"type\": \"text\"}], \"shirtView\": \"front\"}', 'https://res.cloudinary.com/teestudio/image/upload/v1/previews/hoodie-nhiep-anh.jpg', NULL, NULL, 120000.00, 'APPROVED', NULL, '2026-06-14 08:00:00', '2026-07-18 20:33:26'),
...
(18, 18, 1, 2, 'Thiết kế chưa đặt tên', '#ffffff', '{\"elements\": [{\"x\": 225.42857142857144, \"y\": 302, \"id\": \"6610e80b-d318-4ef8-95f7-1bc5311b099a\", \"src\": \"https://res.cloudinary.com/dwol6aarv/image/upload/v1782033392/today_14356090_s4nfxf.png\", \"type\": \"image\", \"width\": 120, \"height\": 120, \"rotation\": 0}, {\"x\": 155.7142857142857, \"y\": 198.5714285714286, \"id\": \"353a64af-ba50-4066-a931-e5bad5b605c8\", \"src\": \"https://res.cloudinary.com/dwol6aarv/image/upload/v1782033314/thank-you_7328366_q8e2f3.png\", \"type\": \"image\", \"width\": 120, \"height\": 120, \"rotation\": 0}], \"shirtView\": \"front\"}', 'https://res.cloudinary.com/dwol6aarv/image/upload/v1784122455/teestudio/user-designs/kz8r8v9vcuybph0qqqw6.png', NULL, NULL, 0.00, 'APPROVED', NULL, '2026-07-11 01:52:03', '2026-07-18 19:17:30'),
(19, 20, 1, 6, '324', '#000000', '{\"elements\": [{\"x\": 194.00000000000003, \"y\": 304.2857142857143, \"id\": \"fe37b149-14f5-4e50-8c78-cf5d895142b3\", \"src\": \"blob:http://localhost:3000/8d4ff24a-24a0-4df9-83ea-3e3b71587644\", \"type\": \"image\", \"width\": 120, \"height\": 120, \"rotation\": 0}, {\"x\": 196.8571428571423, \"y\": 261.91666666666634, \"id\": \"253101f2-bf42-4e9b-9c91-aa826dbecb23\", \"src\": \"https://res.cloudinary.com/dwol6aarv/image/upload/v1784143205/teestudio/user-designs/elkgltmhgmbrxwvchgoq.jpg\", \"type\": \"image\", \"width\": 82.85714285714344, \"height\": 63.59523809523833, \"rotation\": 0}], \"shirtView\": \"front\"}', 'https://res.cloudinary.com/dwol6aarv/image/upload/v1784143203/teestudio/user-designs/nawh24tt6lnkrihgtdpk.png', NULL, NULL, 0.00, 'APPROVED', NULL, '2026-07-11 06:57:46', '2026-07-18 19:48:15');
...
CREATE TABLE IF NOT EXISTS `customerorder` (
  ...
  `paymentType` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '[FROM ADMIN] Chính sách thanh toán ban đầu, bất biến: FULL hoặc DEPOSIT. Không có DEFAULT – backend PHẢI truyền giá trị tường minh để tránh bỏ sót.',
  `paymentStatus` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING' COMMENT '[FROM ADMIN] Tiến độ thanh toán tổng của đơn: PENDING, PARTIALLY_PAID, PAID',
...
(38, 'TS-20260718-0OVCJU', 20, NULL, 29, 600000.00, 0.00, 35000.00, NULL, NULL, NULL, NULL, NULL, NULL, 635000.00, 0.00, 0.00, 'FULL', 'PENDING', 'PENDING', '2026-07-18 19:46:35', '2026-07-18 19:46:35'),
...
(13, 13, 15, 16, 2, 280000.00, 150000.00, 710000.00, 'PRINTING'),
...
(37, 37, 5, 19, 3, 120000.00, 0.00, 360000.00, 'READY_TO_PRINT'),
(38, 37, 6, 19, 1, 120000.00, 0.00, 120000.00, 'PRINTING'),
(39, 37, 2, NULL, 1, 120000.00, 0.00, 120000.00, 'WAITING_DESIGN_APPROVAL'),
(40, 38, 5, 19, 3, 120000.00, 0.00, 360000.00, 'PRINTING'),
(41, 38, 6, 19, 1, 120000.00, 0.00, 120000.00, 'PRINTING'),
(42, 38, 2, NULL, 1, 120000.00, 0.00, 120000.00, 'WAITING_DESIGN_APPROVAL'),
(43, 39, 2, 10, 1, 120000.00, 0.00, 120000.00, 'READY_TO_PRINT'),
(44, 40, 2, 10, 1, 120000.00, 0.00, 120000.00, 'READY_TO_PRINT');
...
(7, 13, 16, 'PRINTING', 'Đã duyệt mẫu, đang nằm trong hàng chờ gửi xưởng.', '2026-06-15 14:00:00', NULL, NULL, '2026-06-15 13:00:00'),
...
(15, 37, 19, 'READY_TO_PRINT', NULL, NULL, NULL, NULL, '2026-07-18 19:46:35'),
(16, 38, 19, 'PRINTING', NULL, NULL, NULL, NULL, '2026-07-18 19:46:35'),
(17, 40, 19, 'PRINTING', NULL, NULL, NULL, NULL, '2026-07-18 19:46:35'),
(18, 41, 19, 'PRINTING', NULL, NULL, NULL, NULL, '2026-07-18 19:46:35'),
(19, 43, 10, 'READY_TO_PRINT', NULL, NULL, NULL, NULL, '2026-07-18 23:22:00'),
(20, 44, 10, 'READY_TO_PRINT', NULL, NULL, NULL, NULL, '2026-07-18 23:22:01');
...
CREATE TABLE IF NOT EXISTS `payment` (
  ...
  `paymentMethod` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Phương thức thanh toán dùng chung: COD, VNPAY, MOMO, BANK_TRANSFER',
  ...
  `note` text COLLATE utf8mb4_unicode_ci COMMENT '[FROM ADMIN] Ghi chú kế toán của admin',
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
(14, 14, 150000.00, 'VNPAY', 'FULL_PAYMENT', 'PENDING', 'VNP202606160141', NULL, '{\"paymentUrlExpiresAt\":\"2026-06-16T09:15:00+07:00\",\"vnp_ResponseId\":\"687e6ef8e85f484a9277fb9e2a48a8df\",\"vnp_Command\":\"querydr\",\"vnp_ResponseCode\":\"91\",\"vnp_Message\":\"Transaction not found\",\"vnp_TmnCode\":\"XZ40IDQS\",\"vnp_TxnRef\":\"VNP202606160141\",\"vnp_SecureHash\":\"a81a58f4ca38238c56c60b372403b5575e9757176e802bb843dc05c153b9f0742b5af59baf710234da0bcd9ea1f7140fa2925d6348232abf10208b26430354ca\",\"source\":\"query\",\"lastReconciledAt\":\"2026-07-21T12:07:46.603Z\"}', 'Đang chờ khách hoàn tất VNPAY.', '2026-06-16 09:00:00'),
...
(38, 38, 635000.00, 'VNPAY', 'FULL_PAYMENT', 'PENDING', 'TS202607180OVCJU', NULL, '{\"paymentUrl\":\"https://sandbox.vnpayment.vn/paymentv2/vpcpay.html?vnp_Amount=63500000&vnp_Command=pay&vnp_CreateDate=20260718194635&vnp_CurrCode=VND&vnp_ExpireDate=20260718200135&vnp_IpAddr=127.0.0.1&vnp_Locale=vn&vnp_OrderInfo=Thanh+toan+don+hang+TS-20260718-0OVCJU&vnp_OrderType=other&vnp_ReturnUrl=http%3A%2F%2Flocalhost%3A3000%2Fthanh-toan-thanh-cong&vnp_TmnCode=XZ40IDQS&vnp_TxnRef=TS202607180OVCJU&vnp_Version=2.1.0&vnp_SecureHash=99ca19a01c318dd5b6de560be3ac071e228524eac3afe01fe241ebbb2344e6da295ddd021294166836fe942006f1f2279c37ebf1f7231c80c8131c7a4e9905d6\",\"expiresAt\":\"2026-07-18T13:01:35.241Z\",\"transactionRef\":\"TS202607180OVCJU\",\"transactionDate\":\"20260718194635\",\"vnp_ResponseId\":\"a54f03e3096345ac9bb5fdd0cd7d0b55\",\"vnp_Command\":\"querydr\",\"vnp_ResponseCode\":\"91\",\"vnp_Message\":\"Transaction not found\",\"vnp_TmnCode\":\"XZ40IDQS\",\"vnp_TxnRef\":\"TS202607180OVCJU\",\"vnp_SecureHash\":\"f3f9d942343cf243ae54c83c864650dc8c2ab87499cb1b73edb029d172b0fd643bae86399c18ab859cf4e9a8d1696dba13c762415bfaf68da512a3b6227d34e9\",\"source\":\"query\",\"lastReconciledAt\":\"2026-07-21T12:07:47.179Z\"}', NULL, '2026-07-18 19:46:35'),
...
--
-- Cấu trúc bảng cho bảng `pricingconfiguration`
--
...
--
-- Đang đổ dữ liệu cho bảng `pricingconfiguration`
--
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `shirtType` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '[FROM MEMBER] Loại áo dùng cho trang khách hàng (ví dụ: tshirt, hoodie, polo)',
  `name` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL,
  `slug` varchar(300) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '[FROM ADMIN] Slug dùng cho URL thân thiện SEO',
...
CREATE TABLE IF NOT EXISTS `productvariant` (
  ...
  `colorHex` char(7) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#94a3b8' COMMENT '[FROM ADMIN] Mã màu HEX tương ứng với tên màu',
  `size` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sku` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `stockQty` int NOT NULL DEFAULT '0',
  `status` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ACTIVE' COMMENT '[FROM ADMIN] Trạng thái variant: ACTIVE / INACTIVE',
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
(5, 1, 'Đen', '#000000', 'S', 'ATCT-DEN-S', 124, 'ACTIVE', '2026-01-07 08:04:00'),
(6, 1, 'Đen', '#000000', 'M', 'ATCT-DEN-M', 188, 'ACTIVE', '2026-01-07 08:05:00'),
...
CREATE TABLE IF NOT EXISTS `promotion` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `discountType` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'PERCENT, FIXED, FREE_SHIPPING',
...
--
-- Đang đổ dữ liệu cho bảng `promotionusage`
--
...
(31, 16, 'abc', '0326323808', '1, Ngọc Đường, Tuyên Quang', 'Tuyên Quang', '', 'Ngọc Đường', 0, '2026-07-18 23:22:01');
...
(98, 18, 'dd8f286a8f0e6698c5b1a341464b55256f822028725edc52327eb023e93311b0', '2026-07-25 19:18:05', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', '::1', '2026-07-18 19:18:05'),
(99, 18, '9181d30790bc14159f6d69b6fc8265089d5cdb2f34dbd67eb6963b6e40d47300', '2026-07-25 19:36:45', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', '::1', '2026-07-18 19:36:45'),
(100, 21, '15608474c9a89517fc17c8e3b766ba567a79c6f497b192ffe34b23341db4bbdc', '2026-07-25 19:40:38', 'curl/8.19.0', '::1', '2026-07-18 19:40:38'),
(107, 20, '720664c2c32c793845feda64e07f25aa97bb4ebcaf1a1ebfee44a165a417d426', '2026-07-25 21:20:07', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', '::1', '2026-07-18 21:20:07'),
(109, 16, '5aff44178179130108cc23ae1756be4a68f52e2276eb9e128f6d74a6c1619fb2', '2026-07-25 21:32:55', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', '::1', '2026-07-18 21:32:55'),
(111, 18, 'c4235034714ca2d75c4798aa8fcce6c5db527a94598243397ed1a6e0e8018d4f', '2026-07-25 22:10:51', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', '::1', '2026-07-18 22:10:51'),
(113, 16, 'c81f4c320688aaf37c9f8eabcf58cd91aa343978725badefbcb6fed3e5f3aedc', '2026-07-25 23:14:43', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', '::1', '2026-07-18 23:14:43');
