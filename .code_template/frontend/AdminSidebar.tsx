...
const navItems: NavItem[] = [
  ...
  { label: "Mẫu Nhà cung cấp", icon: <TeamOutlined />, href: "/admin/template", allowedRoles: ["ADMIN"] },
];
...
function SidebarContent({
  ...
  return (
    <>
      <div
        className={`mb-8 flex items-center ${collapsed ? "justify-center px-2" : "gap-3 px-base"
          }`}
      >
        {collapsed ? null : (
          <>
            ...
            return (
              <li key={item.href}>
                <Link
                  ...
                  className={`mx-2 flex h-11 items-center rounded-[8px] border py-2 text-sidebar-item font-semibold !text-[#0f172a] transition-all duration-200 hover:!text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30 ${collapsed ? "justify-center px-0" : "min-w-0 gap-3 px-4"
                    } ${itemClass}`}
                >
      ...
      <div className="mx-2 mt-4 border-t border-border pt-4">
        ...
        >
          <button
            ...
            className={`flex h-14 w-full items-center rounded-[8px] text-left transition-colors hover:bg-surface-alt focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 ${collapsed ? "justify-center px-0" : "min-w-0 gap-3 px-2"
              }`}
          >
            ...
            {collapsed ? null : (
              <>
                ...
                <DownOutlined
                  className={`shrink-0 text-[11px] text-text-secondary transition-transform duration-200 ${accountMenuOpen ? "rotate-180" : ""
                    }`}
                />
              </>
            )}
  ...
  return (
    <>
      ...
      <aside
        ...
        className={`fixed left-0 top-0 z-50 flex h-screen w-sidebar-w flex-col border-r border-border bg-surface py-base transition-transform duration-200 md:hidden ${mobileOpen ? "translate-x-0" : "-translate-x-full"
          }`}
      >
