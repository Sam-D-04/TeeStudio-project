    ...
    <main style={{ minHeight: "100vh", background: "#f1f5f9" }}>
      ...
      <div style={{ paddingTop: 64 }}>
        <div className="container-main" style={{ padding: "40px 0" }}>
          <h1 style={{ fontSize: 32, fontWeight: 800, marginBottom: 16 }}>Bán hàng cùng TeeStudio</h1>
          <p style={{ color: "#475569", marginBottom: 32 }}>Trở thành nhà sáng tạo, đưa các mẫu thiết kế của bạn tới khách hàng và nhận hoa hồng.</p>
