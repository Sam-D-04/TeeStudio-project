...
CREATE TABLE IF NOT EXISTS `CustomDesign` (
	...
	-- 'SUBMITTED'      = Khách đã gửi (dùng phía customer-web)
...
(1, 1, 2, 10, 'Thiết kế chưa đặt tên', '#FFFFFF', '{"layers": [{"x": 150, "y": 100, "src": "https://res.cloudinary.com/teestudio/image/upload/v1/logos/logo-cty-abc.png", "type": "image", "width": 120, "height": 80, "rotation": 0}], "background": "#FFFFFF"}', 'https://res.cloudinary.com/teestudio/image/upload/v1/previews/preview-order-1.jpg', 150000.00, 'SUBMITTED', NULL, '2026-06-02 08:00:00', '2026-06-02 08:00:00'),
(2, 3, 4, 20, 'Thiết kế chưa đặt tên', '#FFFFFF', '{"layers": [{"x": 100, "y": 80, "type": "text", "color": "#003399", "content": "ĐỒNG PHỤC CÔNG TY XYZ", "fontSize": 24, "fontFamily": "Arial"}, {"x": 170, "y": 120, "src": "https://res.cloudinary.com/teestudio/image/upload/v1/logos/logo-xyz.png", "type": "image", "width": 60, "height": 60}], "background": "#FFFFFF"}', 'https://res.cloudinary.com/teestudio/image/upload/v1/previews/preview-order-3.jpg', 200000.00, 'SUBMITTED', NULL, '2026-06-01 09:00:00', '2026-06-01 09:00:00'),
(3, 5, 1, 2, 'Thiết kế chưa đặt tên', '#FFFFFF', '{"layers": [{"x": 90, "y": 90, "type": "text", "color": "#FF6600", "content": "TEAM BUILDING 2026", "fontSize": 28}], "background": "#FFFFFF"}', 'https://res.cloudinary.com/teestudio/image/upload/v1/previews/preview-order-5.jpg', 100000.00, 'SUBMITTED', NULL, '2026-06-02 09:00:00', '2026-06-02 09:00:00'),
